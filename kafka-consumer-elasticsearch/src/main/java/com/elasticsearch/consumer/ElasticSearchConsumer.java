...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
    	...
    	//https://username:password@kafka-sample-4427730582.ap-southeast-2.bonsaisearch.net:443
        String hostname = "kafka-sample-test.ap-southeast-2.bonsaisearch.net"; // localhost or bonsai url
            ...
            for (ConsumerRecord<String, String> record : records){
                ...
                try {
                    ...
                    */
					 ...
					 * RequestOptions.DEFAULT); logger.info("**"+indexResponse.getId());
					 */
